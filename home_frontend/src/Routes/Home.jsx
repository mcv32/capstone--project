...
function Home() {
    ...
    <section className="bodySection snaps-inline">
        ...
        <div className="media-element homeHero snaps-inline_child" id="homeHero">
      ...
      <div className="homeTeam snaps-inline_child" id="homeTeam">
                    <div> </div>
                    <div></div>
                    <div></div>
                    <div></div>
        ...
        <div className="homeFeatures snaps-inline_child">
            <h1 className="features"> Our Goals </h1>
        ...
        <div className="media-element homeTechStack snaps-inline_child" id="homeTechStack">
